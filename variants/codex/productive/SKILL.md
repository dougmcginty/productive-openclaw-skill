---
name: productive
description: Explicit-only Productive.io timesheet helper for Codex. Use only when the user explicitly asks to use Productive, productive.io, or their Productive timesheet.
---
